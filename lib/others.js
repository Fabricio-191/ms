...
/*
Aparently, these 2 regexes are efficent than this one:
/(\d+)(?<sep>:|-)(?:(\d\d)\k<sep>)?(\d\d(?:\.\d+)?)( PM)?/
And as they dont have a named group, they have better compatibilty with older node.js versions
*/
